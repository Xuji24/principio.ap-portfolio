...
const projects = [
  ...
  {
    title: "Boji-AI",
    description: "An AI-powered web application allowing user to prepare for job from start to finish, from resume building, interview preparation, job searching, and upskilling certifications.",
